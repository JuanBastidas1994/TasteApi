...
$query = "SELECT * FROM `tb_orden_cuponera` WHERE cod_orden = 105529";
$cupones = Conexion::buscarVariosRegistro($query);
...
$asunto = "Cupones comprados en ".$name;
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td align="center" valign="top" style="padding:0;Margin:0;width:540px"> 
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:5px"><h1 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Montserrat, Helvetica, Roboto, Arial, sans-serif;font-size:32px;font-style:normal;font-weight:bold;color:#4A4A4A">Tus cupones</h1></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
                      ...
                      <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px"> 
                        ...
                        <table width="100%">';
                            foreach($cupones as $cupon){
                                ...
                                $html .= '
                                <tr>
                                    <td colspan="3"><p style="margin: 10px 0px 10px 0px;"><strong>'.$codigo.'</strong></p></td>
